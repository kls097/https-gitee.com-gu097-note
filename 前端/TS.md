...
![TS与JS.png](img/vue097/28ca61cc160c417c8497a00defdca5f0~tplv-k3u1fbpfcp-watermark.image)
...
编译器会将ts文件编译成js文件，然后保存到./js文件夹之下。

所以html引用js文件时需要从./js文件夹下引用。
...
第二步：新建一个文件：jQery.d.ts,在里面写上

declare var jQuery: (selector: string) => any;

这个声明文件会自动扫描导入JQery声明文件

第三步：其它文件使用JQuery就会有提示了
...
![lifecycle_2](img/vue097/lifecycle.png)

**vue3 的生命周期**

![019b4f8b36e697fa509b2f9e5cf314eb](img/vue097/019b4f8b36e697fa509b2f9e5cf314eb-1621325872573.jpeg)
...
# 10、Composition API VS Option API

## 1) Option API 的问题

- 在传统的 Vue OptionsAPI 中，新增或者修改一个需求，就需要分别在 data，methods，computed 里修改 ，滚动条反复上下移动

![img](img/vue097/f84e4e2c02424d9a99862ade0a2e4114~tplv-k3u1fbpfcp-watermark.image)

![img](img/vue097/e5ac7e20d1784887a826f6360768a368~tplv-k3u1fbpfcp-watermark.image)

## 2) 使用 Compisition API

我们可以更加优雅的组织我们的代码，函数。让相关功能的代码更加有序的组织在一起

![img](img/vue097/bc0be8211fc54b6c941c036791ba4efe~tplv-k3u1fbpfcp-watermark.image)

![img](img/vue097/6cc55165c0e34069a75fe36f8712eb80~tplv-k3u1fbpfcp-watermark.image)

![img](img/vue097/2c421e5392504ecc94c222057dba338a~tplv-k3u1fbpfcp-watermark.image)
