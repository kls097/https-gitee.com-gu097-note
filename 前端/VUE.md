...
el-menu-item-group：一组导航栏el-date-picker 组件时间格式化方式
el-dialog :弹出对话框
...
以`SpringMVC`流程为例：
![在这里插入图片描述](img/VUE/20200612174447902.png)
...
![在这里插入图片描述](img/VUE/2020061218034279.png)
**优点**
...
![在这里插入图片描述](img/VUE/20200612180725928.png)
缺点
...
![在这里插入图片描述](img/VUE/20200612223107534.png)
...
![在这里插入图片描述](img/VUE/20200612223913421.png)
...
![在这里插入图片描述](img/VUE/20200615175823742.png)
...
![在这里插入图片描述](img/VUE/2020061517580183.png)
...
![在这里插入图片描述](img/VUE/20200616171528707.png)
![在这里插入图片描述](img/VUE/20200616171908189.png)
...
<html>
	...
	<body>
		<div id="comm">
			<mycomp v-for="item in items" v-bind:datay="item"></mycomp>
		</div>
	</body>
	
	<script type="text/javascript">
		//先注册组件,使用props绑定一个datay
		Vue.component("mycomp",{
			props:['datay'],
			template: '<li>{{datay}}</li>'
		});
...
![在这里插入图片描述](img/VUE/20200616222020393.png)
...
- computed：定义计算属性， 调用属性使用currentTime2， 不需要带括号：this.message是为了能够让**currentTime2观察到数据变化而变化**
...
![在这里插入图片描述](img/VUE/20200618181139418.png)
...
![在这里插入图片描述](img/VUE/20200619110151865.JPG)
  **安装vue-cli**
...
![在这里插入图片描述](img/VUE/20200619111125386.JPG)
...
当出现问题时，可以查看提示进行处理如下
![img](img/VUE/20200619113101422.JPG)
...
![在这里插入图片描述](img/VUE/20200619215458179.png)
...
![在这里插入图片描述](img/VUE/20200619234826107.png)
...
5、 路由嵌套实战效果图
![在这里插入图片描述](img/VUE/2020062413282631.png)
...
![在这里插入图片描述](img/VUE/20200624140100715.png)
...
3.效果图
![在这里插入图片描述](img/VUE/20200624142229445.png)
...
5.路由钩子和axios结合图
![在这里插入图片描述](img/VUE/20200624143534392.png)
